...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>新闻内容管理 <span class="c-gray en">&gt;</span> 新增新闻内容 <a
	...
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="article/addArticle.action" name="myform" method="post">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<span class="select-box"><select name="bannerid" class="select" id="bannerid"><option value="">---请选择分类--</option>
