...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>管理员管理 <span class="c-gray en">&gt;</span> 管理员列表 <a
			...
			<table class="table table-border table-bordered table-bg">
				...
				<c:forEach items="${adminList}" var="admin">
					<tr class="text-c">
						...
						<td>${admin.contact}</td>
						<td>${admin.addtime}</td>
						<td><a href="admin/getAdminById.action?id=${admin.adminid}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>&nbsp;&nbsp;<a
							href="admin/deleteAdmin.action?id=${admin.adminid}" onclick="{if(confirm('确定要删除吗?')){return true;}return false;}" title="删除"><i
