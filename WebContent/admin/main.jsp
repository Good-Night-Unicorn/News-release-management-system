		...
		<div class="navbar navbar-fixed-top">
			<div class="container-fluid cl">
				...
				<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
					<ul class="cl">
						<li class="dropDown dropDown_hover"><a class="dropDown_A">${sessionScope.role } <i class="Hui-iconfont">&#xe6d5;</i></a>
							<ul class="dropDown-menu menu radius box-shadow">
								<li><a href="admin/prePwd.action" data-href="admin/prePwd.action" data-title="修改密码" target="main">修改密码</a></li>
								<li><a href="admin/exit.action">退出</a></li>
							</ul></li>
