...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>新闻内容管理 <span class="c-gray en">&gt;</span> 新闻内容查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="9">新闻内容查询</th>
				</tr>
				<tr class="text-c">
		...
		<div class="text-c">
			<form action="article/queryArticleByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select"><option value="">---查询条件---</option>
						...
						<option value="bannerid">按分类查询</option>
						<option value="istop">按是否置顶查询</option>
						<option value="isflv">按是否轮播查询</option>
						<option value="addtime">按发布日期查询</option>
						<option value="hits">按点击数查询</option></select></span>&nbsp;&nbsp;关键字<input type="text" name="name" required style="width: 200px" class="input-text" />
