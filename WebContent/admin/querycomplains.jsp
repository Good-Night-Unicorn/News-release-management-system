...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>意见反馈管理 <span class="c-gray en">&gt;</span> 意见反馈查询 <a
		...
		<div class="text-c">
			<form action="complains/queryComplainsByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select"><option value="">---查询条件---</option>
						...
						<option value="reps">按管理员回复查询</option></select></span>&nbsp;&nbsp;关键字<input type="text" name="name" required style="width: 200px" class="input-text" />
