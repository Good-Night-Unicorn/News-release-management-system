...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>用户评论管理 <span class="c-gray en">&gt;</span> 用户评论查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="5">用户评论查询</th>
				</tr>
				<tr class="text-c">
					<th class="center">用户</th>
					<th class="center">新闻</th>
		...
		<div class="text-c">
			<form action="topic/queryTopicByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select"><option value="">---查询条件---</option>
						...
						<option value="articleid">按新闻查询</option>
						<option value="contents">按内容查询</option>
						<option value="addtime">按日期查询</option></select></span>&nbsp;&nbsp;关键字<input type="text" name="name" required style="width: 200px" class="input-text" />
