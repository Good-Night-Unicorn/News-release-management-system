...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>网站用户管理 <span class="c-gray en">&gt;</span> 网站用户查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="8">网站用户查询</th>
				</tr>
				<tr class="text-c">
		...
		<div class="text-c">
			<form action="users/queryUsersByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select"><option value="">---查询条件---</option>
						...
						<option value="regdate">按注册日期查询</option></select></span>&nbsp;&nbsp;关键字<input type="text" name="name" required style="width: 200px" class="input-text" />
