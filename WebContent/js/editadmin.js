$(function() {
	$('#btnUpdate').click(function() {// 保存按钮点击事件
		...
		var data = { "adminid" : $("#adminid").val(),"username" : $("#username").val(),"password" : $("#password").val(),"realname" : $("#realname").val(),"contact" : $("#contact").val(),"addtime" : $("#addtime").val()};
		var loc = $('#basepath').val();// 获取项目根目录
		var url = loc + "admin/xupdateAdmin.action";// 获取更新数据Controller地址
